...
густина, …) у файл `.bm` для AxiSEM (радіус від центру, одиниці СІ,
найглибший шар — першим).
...
- `--planet-radius <KM>` — задати радіус планети вручну замість автоматичного
  визначення за останнім рядком глибини (Марс ≈ 3389.5 км)
